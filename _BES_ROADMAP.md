...
### [2.7.0] - 2026-02-13
**"Ecosystem Stability Sync"**
- **SYNC:** Types en configuratie gesynchroniseerd met BEP v3.21.0.
- **FIX:** `.env.local` opschoning en Git identiteit herstel.
...
- **FEAT:** **Shared Normalization:** Ecosystem-wide team normalisatie geïmplementeerd in BES. Scanner slaat nu direct gepoetste "home_name_norm" velden op.
